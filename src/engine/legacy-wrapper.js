...
class ParticleSystem$1 extends Entity$1 {
...
class Entity {
    constructor() {
        this.priority = 0;
        this._entity = new Entity$1({ allowOwnEvents: true, bindThisOnEventAction: true, storage: {} });
    }
    on(ev, action) {
        this[ev] = action;
    }
...
class ParticleSystem {
    ...
    constructor(properties) {
        ...
        this._particleSystem = new ParticleSystem$1(false, emitDelay > 0 ? 1000 / emitDelay : 0, true);
